				...
				<aside class="col-span-1">
					...
					<div class="my-6">
						<ul class="bg-white rounded-lg border border-primary  text-primary">
							<li class="p-3 border-b border-primary w-full rounded-t-lg">Javascript</li>
							<li class="p-3 border-b border-primary w-full">Python</li>
							<li class="p-3 border-b border-primary w-full">SvelteKit</li>
							<li class="p-3 w-full rounded-b-lg">Typescript</li>
						</ul>
					</div>
				</aside>
			</main>
